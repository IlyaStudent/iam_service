package com.social_media.iam_service.advice;
...
public class CommonControllerAdvice {
    ...
    @ResponseBody
    protected ResponseEntity<String> handleDataExistsException(Exception ex) {
        logStackTrace(ex);
    ...
    protected ResponseEntity<String> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex) {
        ...
        for (ObjectError error : ex.getBindingResult().getAllErrors()) {
            ...
            errors.put(error.getCode(), errorMessage);
        }
